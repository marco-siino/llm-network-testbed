...
main(int argc, char* argv[])
{
    ...
    /************************
     *  LoRaWAN - Create the channel  *
     ************************/
    NS_LOG_DEBUG("LoRaWAN - Create the channel...");
    ...
    if (realisticChannelModel)
    {
        ...
        Ptr<BuildingsPropagationLossModel> buildingLoss = CreateObject<BuildingsPropagationLossModel>();
     ...
     *  Create the helpers  *
     ************************/
    NS_LOG_DEBUG("LoRaWAN - Create the helpers...");
     ...
     *  Create End Devices  *
     ************************/
    NS_LOG_DEBUG("LoRaWAN - Create End Devices...");
     ...
     *  Create Gateways  *
     *********************/
    NS_LOG_DEBUG("LoRaWAN - Create Gateways...");
     ...
     *  Handle buildings  *
     **********************/
    NS_LOG_DEBUG("LoRaWAN - Handle buildings...");
     ...
     **********************************************/
    NS_LOG_DEBUG("LoRaWAN - Set up the end device's spreading factor...");
     ...
     **************************/
    NS_LOG_DEBUG("LoRaWAN - Create network server...");
